/*
 * File: app/store/guardian/GuardianProfileStore.js
 *
...
Ext.define('MySchool.store.guardian.GuardianProfileStore', {
	...
	constructor: function(cfg) {
		...
		me.callParent([Ext.apply({
			autoLoad: false,
			model: 'MySchool.model.guardian.GuardianProfileModel',
			storeId: 'guardian.GuardianProfileStore',
			proxy: {
				type: 'rest',
				url: 'guardianprofileviews/json',
				headers: {
	...
	onRestException: function(proxy, response, operation, eOpts) {
		debugger;
		window.console.log('GuardianProfileStore() received onRest exception.');
	...
	onJsonstoreLoad: function(store, records, successful, eOpts) {
		//debugger;
		console.log("guardian.GuardianProfileStore.onJsonstoreLoad() called...");
	},

	onJsonstoreWrite: function(store, operation, eOpts) {
		//debugger;
		console.log("guardian.GuardianProfileStore.onJsonstoreWrite(): called...");
		store.reload();
	}
