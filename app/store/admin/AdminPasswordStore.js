/*
 * File: app/store/admin/AdminPasswordStore.js
 *
...
Ext.define('MySchool.store.admin.AdminPasswordStore', {
	...
	constructor: function(cfg) {
		...
		me.callParent([Ext.apply({
			autoLoad: true,
			model: 'MySchool.model.admin.PasswordModel',
			storeId: 'admin.AdminPasswordStore',
			proxy: {
				type: 'rest',
				url: 'adminpasswordviews/json',
				headers: {
